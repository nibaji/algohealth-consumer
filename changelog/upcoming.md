...
- 2026-06-18: Implemented component-specific skeleton loader UI (`<Skeleton />` with preset modes like `<HomeSkeleton />`, `<RecordDetailSkeleton />`, etc.) and integrated them in the dashboard, medical record details, edit member modal, and boot loader screen to replace generic activity indicators. Changed in `components/ui/Skeleton.tsx`, `app/index.tsx`, `app/medicalRecords/[id].tsx`, `components/medicalRecords/EditMemberModal.tsx`, `components/medicalRecords/InvitesModal.tsx`, `app/onboarding.tsx`, `app/_layout.tsx`.
